 ...
 *  - INSIGHTS-023 opened four lifecycle gates into preseason and gated the
 *    participation wording — including insight TITLES — on membership. A
 *    lifecycle change moves the pool, not just the wording, so it qualifies for
 *    the same reason: nothing else in the cache key moves for it.
 *
