...
/**
 * PLATFORM-086H3C1 — participant-validated weekly coverage (DORMANT).
 *
 ...
 * provider id are never addressable and are dropped here (they can satisfy,
 * block, or shadow nothing).
 */
