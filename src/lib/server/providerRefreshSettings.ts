 ...
 * refresh "enabled". The game-stats, live-scores, Team records, Odds, rankings,
 * and weekly-schedule jobs consume these settings; conferences persists an
 * intent no job reads yet.
 */
