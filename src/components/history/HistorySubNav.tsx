...
export function HistorySubNav({ slug }: HistorySubNavProps): React.ReactElement {
  ...
  return (
    <nav aria-label="History sections" className="no-scrollbar flex overflow-x-auto">
      <div className="mb-6 ml-auto flex items-center gap-6 border-b border-gray-200 dark:border-zinc-700">
        {SUBTABS.map((tab) => {
