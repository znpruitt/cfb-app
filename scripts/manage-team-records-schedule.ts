// Operator CLI for the hourly external team-records QStash schedule.
//
// QStash calls the authenticated route on a fixed hourly heartbeat. The route's
// team-record authority—not this schedule—decides whether the 12-hour ceiling is
// due, while live-scores retains its finalisation-triggered call. Shared QStash
// policy supplies inspect-first/apply-gated mutations, fail-closed credential
// handling, provider-side Authorization redaction, and the no-delete contract.
