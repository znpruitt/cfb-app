...
// Rotating `CRON_SECRET` requires pausing then re-upserting ALL THREE schedules
// (game-stats, live-scores, Odds) before the new secret is re-enabled on the routes.
