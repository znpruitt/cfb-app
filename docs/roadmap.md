...
| 086F2 | Admin control-plane IA redesign (F2A audit/IA doc + F2B–F2J implementation slices; plan: `docs/architecture/admin-control-plane.md`) | In progress (F2A–F2D ✅ merged, PRs #430–#434; F2E1 scheduler receipts ✅ merged (PR #435); F2E2A lifecycle receipts + events ✅ merged (PR #436); F2E2B reader/classifier ✅ implemented, PR #437 open; F2F system-health read model next — queue in `docs/next-tasks.md`) |
