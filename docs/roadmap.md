...
| 086F2 | Admin control-plane IA redesign (F2A audit/IA doc + F2B–F2J implementation slices; plan: `docs/architecture/admin-control-plane.md`) | In progress (F2A–F2C ✅ merged, PRs #430–#432; F2D next — queue in `docs/next-tasks.md`) |
