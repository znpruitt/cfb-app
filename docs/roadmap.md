...
- **PLATFORM-086H — game-stats recovery (planned, next).** Schedule-derived expected-game completeness, partial-week retry, non-destructive merge, panel no-op wording.
