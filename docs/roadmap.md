...
- **PLATFORM-086G2 — Odds boundary & usage truthfulness (planned, next).** Odds malformed/unexpected-empty rejection; odds-usage read-failure vs. absence. Separate PR from G1 (different provider family).
