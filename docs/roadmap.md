...
| 086F2 | Admin control-plane IA redesign (F2A audit/IA doc + F2B–F2J implementation slices; plan: `docs/architecture/admin-control-plane.md`) | In progress (F2A–F2D ✅ merged, PRs #430–#434; F2E1 scheduler receipts ✅ merged (PR #435); F2E2 next — queue in `docs/next-tasks.md`) |
