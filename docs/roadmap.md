...
| 086F2 | Admin control-plane IA redesign (F2A audit/IA doc + F2B–F2J implementation slices; plan: `docs/architecture/admin-control-plane.md`) | In progress (F2A–F2D ✅ merged, PRs #430–#434; F2E1/F2E2A/F2E2B scheduler receipts + reader ✅ merged, PRs #435–#437; F2F system-health read model ✅ merged (PR #438); F2G System Health UI ✅ merged (PR #439); F2G1 draft-assistance retirement ✅ merged (PR #440); F2H Season Management is underway as bounded H1A/H1B/H1R/H2/H3 slices, with F2H1A ✅ merged (PR #442) and F2H1B season-transition convergence ✅ merged (PR #443), and F2H1T demo-league automation policy underway as F2H1T1–F2H1T5 with F2H1T1 ✅ merged (PR #445) with F2H1SA protected-path matcher coverage ✅ merged (PR #446) F2H1SB in-action Server-Action authorization ✅ merged (PR #447), F2H1T2 season-transition exclusion ✅ merged (PR #448), F2H1T3 weekly-schedule exclusion ✅ merged (PR #449), F2H1T4 rankings exclusion ✅ merged (PR #450), F2H1T5 System Health operational-year isolation ✅ merged (PR #451), and F2H1R split into five slices (R1 registry truth + season-transition validity ✅ merged (PR #452); R2 weekly-schedule year validity ✅ merged (PR #453); R3 rankings year validity ✅ merged (PR #454); R4 rollover year validity ✅ merged (PR #455) — container truth now complete on all four registry consumers; F2H1R5 RETIRED IN FULL by decision 2026-08-06 — F2H1R is complete through merged R1–R4 plus recorded decisions. All three parts defend a condition unreachable through current application writes (still possible via restore or direct data edit), so R5a System Health year validity and R5b record-level validation are retired with unmerged implementations kept as evidence (`e2c7188`, `f5d9b65`), R5b re-planned as the documented-but-unscheduled PLATFORM-087 response plan, and R5c retired for having zero production targets); F2H2 rollover/archive consolidation is underway — audited 2026-08-06, which retired two of five chartered items and rescoped the UI consolidation, with F2H2A ✅ merged (PR #456) retiring the admin season backfill surface outright rather than hardening an irreversible, publicly visible, untested write — the F2H1T demo-league automation policy is COMPLETE (T1–T5, PRs #445, #448–#451); F2H2B rollover operator truth next — queue in `docs/next-tasks.md`) |
