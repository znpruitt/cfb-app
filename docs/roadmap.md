...
| 086F2 | Admin control-plane IA redesign (F2A audit/IA doc + F2B–F2J implementation slices; plan: `docs/architecture/admin-control-plane.md`) | In progress (F2A–F2B ✅ merged, PRs #430–#431; F2C implemented — PR open; queue in `docs/next-tasks.md`) |
