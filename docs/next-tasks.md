...
| 4 | Schedule team-name form | **#729** | `gameWeek.ts`, `DESIGN.md` | **NEXT — OWNER RULED 2026-09-16: full names.** `DESIGN.md` amended the same day; kickoff `docs/prompts/platform-729-schedule-team-names-codex-v1.md`. Measured: the production catalog carries no short name for any of 138 FBS teams, so Schedule abbreviates every FBS team, not only the two the issue names |
