...
- **DOCS-002A** (PR #375) — documentation index + governance tightening. **DOCS-002B** — this planning/history cleanup. **DOCS-002C** — architecture/operations docs (deferred; tracked in `docs/README.md`).
