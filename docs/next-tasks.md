...
- **DOCS-002A** (PR #375) — documentation index + governance tightening. **DOCS-002B** — this planning/history cleanup. **DOCS-002C** (PR #377) — dedicated architecture (`docs/architecture/`) + operations (`docs/operations/`) doc layer. **DOCS-004** — reconciled the `DESIGN.md` rank-number + game-card-border contradictions. Remaining doc follow-ups (lifecycle-metadata rollout, `archive/` path decision) tracked in `docs/README.md`.
