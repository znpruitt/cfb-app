...
| 4 | Schedule team-name form | **#729** | `gameWeek.ts`, `DESIGN.md` | **IMPLEMENTED AND REVIEWED 2026-09-17 — MERGE PENDING.** Schedule and Postseason now use the same provider-name fields as Overview and Matchups; the cross-surface source is mutation-pinned. The browser gate covers single-line ellipsis behavior, a stable right anchor, and a real clipping control. [#810](https://github.com/znpruitt/cfb-app/issues/810) remains open and is unblocked by this merge |
