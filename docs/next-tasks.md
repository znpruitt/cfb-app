...
- **DOCS-002A** (PR #375) — documentation index + governance tightening. **DOCS-002B** — this planning/history cleanup. **DOCS-002C** (PR #377) — dedicated architecture (`docs/architecture/`) + operations (`docs/operations/`) doc layer. Remaining doc follow-ups (design-contradiction cleanup, lifecycle-metadata rollout, `archive/` path decision) tracked in `docs/README.md`.
