...
| 8 | Compact header wrap at phone width | **#797** (carries **#758**) | `CompactGameScoreboard.tsx` | **Merged [PR #864](https://github.com/znpruitt/cfb-app/pull/864), `37354e6d`.** Infrastructure follow-up #870 remains deferred; owner resolved the DESIGN rationale in `dd69113f`. [Execution record](prompt-registry.md#platform-797-header-wrap-codex-v1). |
