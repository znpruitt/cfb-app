...
| ✅ | ~~Abbreviation lookup~~ | ~~#831~~ | `src/data/team-abbreviations.json`, `teamAbbreviations.ts` | **MERGED `41f688c5` (PR #834) 2026-09-20; #831 closed. NOT LIVE until promoted.** A pinned 2026 artifact of all 682 provider schools (679 abbreviations, 3 explicit nulls) plus a client-safe `getTeamAbbreviation(school)`. **The catalog is untouched** — the draft-visibility observer is the safety proof, not the row count. Unblocks [#832](https://github.com/znpruitt/cfb-app/issues/832) |
