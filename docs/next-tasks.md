...
- **PLATFORM-073** — postseason attachment edge cases: half-hydrated games unindexed even by provider id, null-`seasonType` cross-phase rematch, week-remap guard when postseason-only input (P2). **Next correctness task.**
