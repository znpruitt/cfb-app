...
- Status: **MERGED 2026-09-23.** Ships with ONE known low finding, left unfixed on purpose and tracked as
  ...
  margin erosion, no traced case breaches 300s, one-line fix. **Both figures superseded: the read is at least ~60s
  (four composed 15s bounds) and the pre-fix worst case BREACHED the 300s ceiling — see #866.** Runbook §8i gates installing the QStash
