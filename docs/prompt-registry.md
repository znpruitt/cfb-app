...
- Status: **Implemented on branch `platform/086g2-odds-boundary-usage-truthfulness` (2026-07-14); pending independent review — no PR opened or merged.** If review remediation changes behavior, this entry is updated again before merge so it describes the final reviewed implementation.
