...
- Follow-ups: Operator can now dry-run against a read-only connection, then `--apply` against a writable primary. Unblocks the PLATFORM-081 production `--apply` operator step.
