...
- Status: **✅ implemented + review-converged; PR to `main` OPEN, awaiting owner merge; MANUAL-ONLY (automatic enrichment dormant until E1C2).** NEXT: PLATFORM-086E1C2 (automatic enrichment wiring — the authority's `weekly`/`season-transition` triggers); 086E2 rankings follows E1C2.
