...
- **Optional follow-up debt (non-blocking):** §8h activation (operator-run, now unblocked); E1C presentation enrichment after activation; 086E2 rankings after §8h closes; the documented conservative unparseable-`firstGameDate` divergence and pre-existing probe-staleness-vs-CFBD property carried as known non-blockers.
