...
**PROMPT_ID(s):** PLATFORM-086H3-ATOMIC-CONTRACT-ACTIVATION-RECOVERY-INTEGRATION-v1 (+ folded PLATFORM-086H3-CANONICAL-COVERAGE-RECOVERY-REMEDIATION-v1 and PLATFORM-086H3-IDENTITY-RECOVERY-CLAIM-PUBLIC-CONTRACT-REMEDIATION-v1).
